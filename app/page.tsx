  ...
  return (
    <main id="top" className="overflow-hidden">
      ...
      <section className="relative min-h-[860px] overflow-hidden bg-[radial-gradient(circle_at_80%_10%,#d8eee7_0,transparent_38%),linear-gradient(180deg,#f5faf7_0%,#eef5f2_100%)] pt-[78px]">
        ...
        <div className="absolute -left-32 top-40 h-96 w-96 rounded-full bg-[#b9dfd4]/35 blur-3xl" />
        <div className="absolute -right-20 bottom-0 h-[460px] w-[460px] rounded-full bg-[#d7e7de]/70 blur-3xl" />
        ...
        <div className="relative border-y border-[#d6e4df] bg-white/65 backdrop-blur-md">
          <div className="mx-auto grid max-w-[1240px] grid-cols-2 gap-y-8 px-5 py-7 md:grid-cols-4 lg:px-8">
            {[
              ...
              <div key={label} className={`px-4 ${index > 0 ? "md:border-l md:border-[#d6e4df]" : ""}`}>
      ...
      <section id="services" className="bg-[#fbfdfc] py-24 md:py-32">
        <div className="mx-auto max-w-[1240px] px-5 lg:px-8">
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            ...
            <a href="#contact" className="inline-flex shrink-0 items-center gap-2 self-start text-sm font-bold text-[#0f7466] transition hover:gap-3 lg:self-auto">
          ...
          <div className="mt-14 grid gap-5 md:grid-cols-2">
            {services.map((service) => {
              ...
              return (
                <article key={service.title} className="group relative overflow-hidden rounded-[2rem] border border-[#dbe7e3] bg-white p-7 transition duration-300 hover:-translate-y-1 hover:border-[#a9c9c0] hover:shadow-[0_24px_70px_rgba(18,62,58,.09)] md:p-9">
        ...
        <div className="relative mx-auto max-w-[1240px] px-5 lg:px-8">
          ...
          <div className="mt-16 grid gap-px overflow-hidden rounded-[2rem] border border-white/10 bg-white/10 md:grid-cols-2 lg:grid-cols-4">
            {approach.map(([title, text], index) => (
              <article key={title} className="min-h-[310px] bg-[#123e3a] p-7 md:p-8">
          ...
          <div className="mt-14 grid gap-5 lg:grid-cols-[1.15fr_.85fr]">
            ...
            <div className="rounded-[2rem] bg-[#e7f3ef] p-7 md:p-10">
        ...
        <div className="mx-auto max-w-[1240px] px-5 lg:px-8">
          <div className="grid gap-14 lg:grid-cols-[.92fr_1.08fr] lg:items-center">
            <div className="relative">
              <div className="relative aspect-square overflow-hidden rounded-[2.5rem] bg-black shadow-[0_30px_90px_rgba(18,62,58,.15)]">
              ...
              <div className="absolute -bottom-6 -right-3 max-w-[260px] rounded-2xl border border-white/60 bg-white/90 p-5 shadow-[0_18px_50px_rgba(18,62,58,.15)] backdrop-blur md:-right-8">
            ...
            <div>
              ...
              <div className="mt-10 grid gap-4">
                {[
                  ...
                  <div key={title} className="rounded-2xl border border-[#d9e6e1] bg-white p-5 md:p-6">
          ...
          <div className="mt-24 grid gap-5 md:grid-cols-3">
            {[
              ...
              <article key={title} className="group overflow-hidden rounded-[2rem] bg-white shadow-[0_18px_60px_rgba(18,62,58,.07)]">
        ...
        <div className="mx-auto max-w-[1240px] px-5 lg:px-8">
          ...
          <div className="mt-14 grid gap-5 lg:grid-cols-3">
            {team.map((member, index) => (
              <article key={member.name} className="group rounded-[2rem] border border-[#dbe7e3] bg-white p-7 transition hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(18,62,58,.09)]">
                <div className="flex items-start justify-between">
      ...
      <section className="bg-[#eaf3f0] py-24 md:py-32">
        <div className="mx-auto max-w-[1240px] px-5 lg:px-8">
          <p className="mb-12 text-xs font-bold uppercase tracking-[.22em] text-[#0f7466]">Patient and participant experiences</p>
          <Testimonials />
        </div>
      </section>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-[1240px] px-5 lg:px-8">
          <p className="text-center text-xs font-bold uppercase tracking-[.22em] text-[#718984]">Partners and professional affiliations</p>
          <div className="mt-10 grid items-center gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {partnerLogos.map(([src, alt]) => (
              <div key={src} className="flex h-28 items-center justify-center rounded-2xl border border-[#e2ebe8] bg-[#fbfdfc] p-5">
                <Image src={src} alt={alt} width={260} height={80} className="max-h-16 w-auto max-w-full object-contain" />
              </div>
            ))}
          </div>
          <p className="mx-auto mt-8 max-w-3xl text-center text-xs leading-5 text-[#849792]">Affiliations and partner logos are shown for informational purposes and do not necessarily indicate endorsement of every service described on this website.</p>
        </div>
      </section>

      <section id="contact" className="relative overflow-hidden bg-[#f1f7f4] py-24 md:py-32">
        <div className="absolute -left-36 bottom-0 h-[420px] w-[420px] rounded-full bg-[#cfe7df]/60 blur-3xl" />
        <div className="relative mx-auto grid max-w-[1240px] gap-14 px-5 lg:grid-cols-[.82fr_1.18fr] lg:items-start lg:px-8">
          <div>
            ...
            <div className="mt-10 grid gap-4">
              <a href="tel:+15168842442" className="flex items-center gap-4 rounded-2xl border border-[#d5e4df] bg-white/70 p-4 transition hover:border-[#0f7466]">
              ...
              <div className="flex items-center gap-4 rounded-2xl border border-[#d5e4df] bg-white/70 p-4">
            ...
            <div className="mt-8 rounded-2xl bg-[#fff7e8] p-5 text-sm leading-6 text-[#795f2f]">
