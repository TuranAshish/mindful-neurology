  ...
  return (
    <main className="min-h-screen bg-[#f1f7f4] px-5 py-24 text-[#173b38]">
      <section className="mx-auto max-w-2xl rounded-[2rem] bg-white p-8 shadow-[0_24px_80px_rgba(18,62,58,.12)] md:p-12">
        <p className="text-xs font-bold uppercase tracking-[0.22em] text-[#0f7466]">Payment cancelled</p>
        <h1 className="mt-4 font-serif text-4xl font-semibold tracking-[-0.04em] md:text-5xl">No payment was taken.</h1>
        <p className="mt-5 leading-8 text-[#5f7873]">
          You cancelled Stripe Checkout. You can return to the website and try again whenever you are ready.
        </p>
